                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('category#edit')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input id="cc-pament" name="id" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{$category->id}}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="cc-payment" class="control-label mb-1">Category Name</label>
                                <input id="cc-pament" name="name" type="text" class="form-control" aria-required="true" value="{{$category->name}}" aria-invalid="false">
                            </div>
                            <div>
